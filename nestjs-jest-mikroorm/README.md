# Suites + NestJS + Jest + MikroORM

Simple user management example demonstrating [Suites](https://suites.dev) with NestJS, Jest, and MikroORM.
...
- ✅ **MikroORM integration** - Entity-based database access with MikroORM
...
├── user.entity.ts        # MikroORM entity definition
...
This example uses MikroORM for entity-based database access. The entity is defined using decorators:
